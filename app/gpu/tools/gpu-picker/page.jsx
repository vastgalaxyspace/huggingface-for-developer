...
import { ArrowLeft, ArrowRight, Calculator, Cpu, Info, SearchCheck } from "lucide-react";
    ...
    <div className="min-h-[calc(100vh-78px)] bg-[#f2f6fb] py-8 md:py-12">
      <div className="shell-container">
        <section className="rounded-[20px] border border-[#d7dfe8] bg-white p-6 shadow-[0_12px_30px_rgba(31,45,61,0.08)] md:p-8">
          <Link
            href="/gpu"
            className="inline-flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.2em] text-[#234867] transition-colors hover:text-[#173d61]"
            aria-label="Back to GPU"
          >
            <ArrowLeft className="h-3.5 w-3.5" /> Back to GPU
          </Link>
          <p className="mt-7 text-[11px] font-semibold uppercase tracking-[0.24em] text-[#71859b]">Precision Tool</p>
