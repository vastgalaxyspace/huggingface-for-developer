      ...
      <div className="shell-container py-8">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div className="flex flex-col gap-2 text-sm text-[var(--text-muted)] md:flex-row md:items-center">
            <span className="font-extrabold uppercase tracking-[0.28em] text-[var(--text-faint)]">Model Explorer</span>
            <span className="hidden text-[var(--border-strong)] md:inline">|</span>
            <span>&copy; 2024 Precision Architect Model Explorer. High-End Editorial License.</span>
          </div>
